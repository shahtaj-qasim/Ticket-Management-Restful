...
public final class HelloServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<de.uniba.rz.io.rpc.HelloRequest,
      de.uniba.rz.io.rpc.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Hello",
      requestType = de.uniba.rz.io.rpc.HelloRequest.class,
      responseType = de.uniba.rz.io.rpc.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<de.uniba.rz.io.rpc.HelloRequest,
      de.uniba.rz.io.rpc.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<de.uniba.rz.io.rpc.HelloRequest, de.uniba.rz.io.rpc.HelloResponse> getHelloMethod;
    if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
      synchronized (HelloServiceGrpc.class) {
        if ((getHelloMethod = HelloServiceGrpc.getHelloMethod) == null) {
          HelloServiceGrpc.getHelloMethod = getHelloMethod = 
              io.grpc.MethodDescriptor.<de.uniba.rz.io.rpc.HelloRequest, de.uniba.rz.io.rpc.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "HelloService", "Hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  de.uniba.rz.io.rpc.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  de.uniba.rz.io.rpc.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hello(de.uniba.rz.io.rpc.HelloRequest request,
        io.grpc.stub.StreamObserver<de.uniba.rz.io.rpc.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                de.uniba.rz.io.rpc.HelloRequest,
                de.uniba.rz.io.rpc.HelloResponse>(
                  this, METHODID_HELLO)))
          .build();
    }
  }
  ...
  public static final class HelloServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloServiceBlockingStub> {
    ...
    /**
     */
    public de.uniba.rz.io.rpc.HelloResponse hello(de.uniba.rz.io.rpc.HelloRequest request) {
  ...
  public static final class HelloServiceFutureStub extends io.grpc.stub.AbstractStub<HelloServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<de.uniba.rz.io.rpc.HelloResponse> hello(
        de.uniba.rz.io.rpc.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((de.uniba.rz.io.rpc.HelloRequest) request,
              (io.grpc.stub.StreamObserver<de.uniba.rz.io.rpc.HelloResponse>) responseObserver);
          break;
        default:
